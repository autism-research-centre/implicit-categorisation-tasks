...
Line1 = 'When you are ready to start the demo' 
Line2 = 'press SPACEBAR to begin!'
...
Line1 = 'When you are ready to start the main task' 
Line2 = 'press SPACEBAR to begin!'
...
Line1 = 'The first part of the task is now complete.' 
Line2 = 'Press SPACEBAR to continue.'
...
function testing_phase
    ...
    test_data = read_mixed_csv('test_trials2.csv',',');
...
function training_phase
        ...
        data = read_mixed_csv('trial_order2.csv',',');    
